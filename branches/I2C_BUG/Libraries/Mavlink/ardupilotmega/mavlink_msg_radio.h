 ...
 */
static __inline uint16_t mavlink_msg_radio_pack(uint8_t system_id, uint8_t component_id, mavlink_message_t* msg,
 ...
 * @return length of the message in bytes (excluding serial stream start sign)
 */
static __inline uint16_t mavlink_msg_radio_pack_chan(uint8_t system_id, uint8_t component_id, uint8_t chan,
 ...
 */
static __inline uint16_t mavlink_msg_radio_encode(uint8_t system_id, uint8_t component_id, mavlink_message_t* msg, const mavlink_radio_t* radio)
{
...
static __inline void mavlink_msg_radio_send(mavlink_channel_t chan, uint8_t rssi, uint8_t remrssi, uint8_t txbuf, uint8_t noise, uint8_t remnoise, uint16_t rxerrors, uint16_t fixed)
{
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
	char buf[9];
	_mav_put_uint16_t(buf, 0, rxerrors);
 ...
 */
static __inline uint8_t mavlink_msg_radio_get_rssi(const mavlink_message_t* msg)
{
 ...
 */
static __inline uint8_t mavlink_msg_radio_get_remrssi(const mavlink_message_t* msg)
{
 ...
 */
static __inline uint8_t mavlink_msg_radio_get_txbuf(const mavlink_message_t* msg)
{
 ...
 */
static __inline uint8_t mavlink_msg_radio_get_noise(const mavlink_message_t* msg)
{
 ...
 */
static __inline uint8_t mavlink_msg_radio_get_remnoise(const mavlink_message_t* msg)
{
 ...
 */
static __inline uint16_t mavlink_msg_radio_get_rxerrors(const mavlink_message_t* msg)
{
 ...
 */
static __inline uint16_t mavlink_msg_radio_get_fixed(const mavlink_message_t* msg)
{
 ...
 */
static __inline void mavlink_msg_radio_decode(const mavlink_message_t* msg, mavlink_radio_t* radio)
{
