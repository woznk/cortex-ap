 ...
 */
static __inline uint16_t mavlink_msg_mount_status_pack(uint8_t system_id, uint8_t component_id, mavlink_message_t* msg,
 ...
 * @return length of the message in bytes (excluding serial stream start sign)
 */
static __inline uint16_t mavlink_msg_mount_status_pack_chan(uint8_t system_id, uint8_t component_id, uint8_t chan,
 ...
 */
static __inline uint16_t mavlink_msg_mount_status_encode(uint8_t system_id, uint8_t component_id, mavlink_message_t* msg, const mavlink_mount_status_t* mount_status)
{
...
static __inline void mavlink_msg_mount_status_send(mavlink_channel_t chan, uint8_t target_system, uint8_t target_component, int32_t pointing_a, int32_t pointing_b, int32_t pointing_c)
{
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
	char buf[14];
	_mav_put_int32_t(buf, 0, pointing_a);
 ...
 * @return System ID
 */
static __inline uint8_t mavlink_msg_mount_status_get_target_system(const mavlink_message_t* msg)
{
 ...
 * @return Component ID
 */
static __inline uint8_t mavlink_msg_mount_status_get_target_component(const mavlink_message_t* msg)
{
 ...
 */
static __inline int32_t mavlink_msg_mount_status_get_pointing_a(const mavlink_message_t* msg)
{
 ...
 */
static __inline int32_t mavlink_msg_mount_status_get_pointing_b(const mavlink_message_t* msg)
{
 ...
 */
static __inline int32_t mavlink_msg_mount_status_get_pointing_c(const mavlink_message_t* msg)
{
 ...
 */
static __inline void mavlink_msg_mount_status_decode(const mavlink_message_t* msg, mavlink_mount_status_t* mount_status)
{
