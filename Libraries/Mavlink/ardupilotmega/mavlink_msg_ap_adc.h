 ...
 */
static __inline uint16_t mavlink_msg_ap_adc_pack(uint8_t system_id, uint8_t component_id, mavlink_message_t* msg,
 ...
 * @return length of the message in bytes (excluding serial stream start sign)
 */
static __inline uint16_t mavlink_msg_ap_adc_pack_chan(uint8_t system_id, uint8_t component_id, uint8_t chan,
 ...
 */
static __inline uint16_t mavlink_msg_ap_adc_encode(uint8_t system_id, uint8_t component_id, mavlink_message_t* msg, const mavlink_ap_adc_t* ap_adc)
{
...
static __inline void mavlink_msg_ap_adc_send(mavlink_channel_t chan, uint16_t adc1, uint16_t adc2, uint16_t adc3, uint16_t adc4, uint16_t adc5, uint16_t adc6)
{
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
	char buf[12];
	_mav_put_uint16_t(buf, 0, adc1);
 ...
 * @return ADC output 1
 */
static __inline uint16_t mavlink_msg_ap_adc_get_adc1(const mavlink_message_t* msg)
{
 ...
 * @return ADC output 2
 */
static __inline uint16_t mavlink_msg_ap_adc_get_adc2(const mavlink_message_t* msg)
{
 ...
 * @return ADC output 3
 */
static __inline uint16_t mavlink_msg_ap_adc_get_adc3(const mavlink_message_t* msg)
{
 ...
 * @return ADC output 4
 */
static __inline uint16_t mavlink_msg_ap_adc_get_adc4(const mavlink_message_t* msg)
{
 ...
 * @return ADC output 5
 */
static __inline uint16_t mavlink_msg_ap_adc_get_adc5(const mavlink_message_t* msg)
{
 ...
 * @return ADC output 6
 */
static __inline uint16_t mavlink_msg_ap_adc_get_adc6(const mavlink_message_t* msg)
{
 ...
 */
static __inline void mavlink_msg_ap_adc_decode(const mavlink_message_t* msg, mavlink_ap_adc_t* ap_adc)
{
