 ...
 */
static __inline uint16_t mavlink_msg_mount_control_pack(uint8_t system_id, uint8_t component_id, mavlink_message_t* msg,
 ...
 * @return length of the message in bytes (excluding serial stream start sign)
 */
static __inline uint16_t mavlink_msg_mount_control_pack_chan(uint8_t system_id, uint8_t component_id, uint8_t chan,
 ...
 */
static __inline uint16_t mavlink_msg_mount_control_encode(uint8_t system_id, uint8_t component_id, mavlink_message_t* msg, const mavlink_mount_control_t* mount_control)
{
...
static __inline void mavlink_msg_mount_control_send(mavlink_channel_t chan, uint8_t target_system, uint8_t target_component, int32_t input_a, int32_t input_b, int32_t input_c, uint8_t save_position)
{
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
	char buf[15];
	_mav_put_int32_t(buf, 0, input_a);
 ...
 * @return System ID
 */
static __inline uint8_t mavlink_msg_mount_control_get_target_system(const mavlink_message_t* msg)
{
 ...
 * @return Component ID
 */
static __inline uint8_t mavlink_msg_mount_control_get_target_component(const mavlink_message_t* msg)
{
 ...
 */
static __inline int32_t mavlink_msg_mount_control_get_input_a(const mavlink_message_t* msg)
{
 ...
 */
static __inline int32_t mavlink_msg_mount_control_get_input_b(const mavlink_message_t* msg)
{
 ...
 */
static __inline int32_t mavlink_msg_mount_control_get_input_c(const mavlink_message_t* msg)
{
 ...
 */
static __inline uint8_t mavlink_msg_mount_control_get_save_position(const mavlink_message_t* msg)
{
 ...
 */
static __inline void mavlink_msg_mount_control_decode(const mavlink_message_t* msg, mavlink_mount_control_t* mount_control)
{
