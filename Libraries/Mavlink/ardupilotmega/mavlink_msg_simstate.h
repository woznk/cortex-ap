 ...
 */
static __inline uint16_t mavlink_msg_simstate_pack(uint8_t system_id, uint8_t component_id, mavlink_message_t* msg,
 ...
 * @return length of the message in bytes (excluding serial stream start sign)
 */
static __inline uint16_t mavlink_msg_simstate_pack_chan(uint8_t system_id, uint8_t component_id, uint8_t chan,
 ...
 */
static __inline uint16_t mavlink_msg_simstate_encode(uint8_t system_id, uint8_t component_id, mavlink_message_t* msg, const mavlink_simstate_t* simstate)
{
...
static __inline void mavlink_msg_simstate_send(mavlink_channel_t chan, float roll, float pitch, float yaw, float xacc, float yacc, float zacc, float xgyro, float ygyro, float zgyro)
{
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
	char buf[36];
	_mav_put_float(buf, 0, roll);
 ...
 */
static __inline float mavlink_msg_simstate_get_roll(const mavlink_message_t* msg)
{
 ...
 */
static __inline float mavlink_msg_simstate_get_pitch(const mavlink_message_t* msg)
{
 ...
 */
static __inline float mavlink_msg_simstate_get_yaw(const mavlink_message_t* msg)
{
 ...
 */
static __inline float mavlink_msg_simstate_get_xacc(const mavlink_message_t* msg)
{
 ...
 */
static __inline float mavlink_msg_simstate_get_yacc(const mavlink_message_t* msg)
{
 ...
 */
static __inline float mavlink_msg_simstate_get_zacc(const mavlink_message_t* msg)
{
 ...
 */
static __inline float mavlink_msg_simstate_get_xgyro(const mavlink_message_t* msg)
{
 ...
 */
static __inline float mavlink_msg_simstate_get_ygyro(const mavlink_message_t* msg)
{
 ...
 */
static __inline float mavlink_msg_simstate_get_zgyro(const mavlink_message_t* msg)
{
 ...
 */
static __inline void mavlink_msg_simstate_decode(const mavlink_message_t* msg, mavlink_simstate_t* simstate)
{
