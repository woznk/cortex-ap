 ...
 */
static __inline uint16_t mavlink_msg_ahrs_pack(uint8_t system_id, uint8_t component_id, mavlink_message_t* msg,
 ...
 * @return length of the message in bytes (excluding serial stream start sign)
 */
static __inline uint16_t mavlink_msg_ahrs_pack_chan(uint8_t system_id, uint8_t component_id, uint8_t chan,
 ...
 */
static __inline uint16_t mavlink_msg_ahrs_encode(uint8_t system_id, uint8_t component_id, mavlink_message_t* msg, const mavlink_ahrs_t* ahrs)
{
...
static __inline void mavlink_msg_ahrs_send(mavlink_channel_t chan, float omegaIx, float omegaIy, float omegaIz, float accel_weight, float renorm_val, float error_rp, float error_yaw)
{
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
	char buf[28];
	_mav_put_float(buf, 0, omegaIx);
 ...
 */
static __inline float mavlink_msg_ahrs_get_omegaIx(const mavlink_message_t* msg)
{
 ...
 */
static __inline float mavlink_msg_ahrs_get_omegaIy(const mavlink_message_t* msg)
{
 ...
 */
static __inline float mavlink_msg_ahrs_get_omegaIz(const mavlink_message_t* msg)
{
 ...
 */
static __inline float mavlink_msg_ahrs_get_accel_weight(const mavlink_message_t* msg)
{
 ...
 */
static __inline float mavlink_msg_ahrs_get_renorm_val(const mavlink_message_t* msg)
{
 ...
 */
static __inline float mavlink_msg_ahrs_get_error_rp(const mavlink_message_t* msg)
{
 ...
 */
static __inline float mavlink_msg_ahrs_get_error_yaw(const mavlink_message_t* msg)
{
 ...
 */
static __inline void mavlink_msg_ahrs_decode(const mavlink_message_t* msg, mavlink_ahrs_t* ahrs)
{
