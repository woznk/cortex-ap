...
static __inline void mavlink_msg_manual_control_send(mavlink_channel_t chan, uint8_t target, float roll, float pitch, float yaw, float thrust, uint8_t roll_manual, uint8_t pitch_manual, uint8_t yaw_manual, uint8_t thrust_manual)
{
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
	char buf[21];
	_mav_put_float(buf, 0, roll);
 ...
 * @return roll
 */
static __inline float mavlink_msg_manual_control_get_roll(const mavlink_message_t* msg)
{
 ...
 * @return pitch
 */
static __inline float mavlink_msg_manual_control_get_pitch(const mavlink_message_t* msg)
{
 ...
 * @return yaw
 */
static __inline float mavlink_msg_manual_control_get_yaw(const mavlink_message_t* msg)
{
 ...
 * @return thrust
 */
static __inline float mavlink_msg_manual_control_get_thrust(const mavlink_message_t* msg)
{
 ...
 */
static __inline uint8_t mavlink_msg_manual_control_get_roll_manual(const mavlink_message_t* msg)
{
 ...
 */
static __inline uint8_t mavlink_msg_manual_control_get_pitch_manual(const mavlink_message_t* msg)
{
 ...
 */
static __inline uint8_t mavlink_msg_manual_control_get_yaw_manual(const mavlink_message_t* msg)
{
 ...
 */
static __inline uint8_t mavlink_msg_manual_control_get_thrust_manual(const mavlink_message_t* msg)
{
