 ...
 */
static __inline uint16_t mavlink_msg_fence_point_pack(uint8_t system_id, uint8_t component_id, mavlink_message_t* msg,
 ...
 * @return length of the message in bytes (excluding serial stream start sign)
 */
static __inline uint16_t mavlink_msg_fence_point_pack_chan(uint8_t system_id, uint8_t component_id, uint8_t chan,
 ...
 */
static __inline uint16_t mavlink_msg_fence_point_encode(uint8_t system_id, uint8_t component_id, mavlink_message_t* msg, const mavlink_fence_point_t* fence_point)
{
...
static __inline void mavlink_msg_fence_point_send(mavlink_channel_t chan, uint8_t target_system, uint8_t target_component, uint8_t idx, uint8_t count, float lat, float lng)
{
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
	char buf[12];
	_mav_put_float(buf, 0, lat);
 ...
 * @return System ID
 */
static __inline uint8_t mavlink_msg_fence_point_get_target_system(const mavlink_message_t* msg)
{
 ...
 * @return Component ID
 */
static __inline uint8_t mavlink_msg_fence_point_get_target_component(const mavlink_message_t* msg)
{
 ...
 */
static __inline uint8_t mavlink_msg_fence_point_get_idx(const mavlink_message_t* msg)
{
 ...
 */
static __inline uint8_t mavlink_msg_fence_point_get_count(const mavlink_message_t* msg)
{
 ...
 */
static __inline float mavlink_msg_fence_point_get_lat(const mavlink_message_t* msg)
{
 ...
 */
static __inline float mavlink_msg_fence_point_get_lng(const mavlink_message_t* msg)
{
 ...
 */
static __inline void mavlink_msg_fence_point_decode(const mavlink_message_t* msg, mavlink_fence_point_t* fence_point)
{
