 ...
 */
static __inline uint16_t mavlink_msg_digicam_control_pack(uint8_t system_id, uint8_t component_id, mavlink_message_t* msg,
 ...
 * @return length of the message in bytes (excluding serial stream start sign)
 */
static __inline uint16_t mavlink_msg_digicam_control_pack_chan(uint8_t system_id, uint8_t component_id, uint8_t chan,
 ...
 */
static __inline uint16_t mavlink_msg_digicam_control_encode(uint8_t system_id, uint8_t component_id, mavlink_message_t* msg, const mavlink_digicam_control_t* digicam_control)
{
...
static __inline void mavlink_msg_digicam_control_send(mavlink_channel_t chan, uint8_t target_system, uint8_t target_component, uint8_t session, uint8_t zoom_pos, int8_t zoom_step, uint8_t focus_lock, uint8_t shot, uint8_t command_id, uint8_t extra_param, float extra_value)
{
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
	char buf[13];
	_mav_put_float(buf, 0, extra_value);
 ...
 * @return System ID
 */
static __inline uint8_t mavlink_msg_digicam_control_get_target_system(const mavlink_message_t* msg)
{
 ...
 * @return Component ID
 */
static __inline uint8_t mavlink_msg_digicam_control_get_target_component(const mavlink_message_t* msg)
{
 ...
 */
static __inline uint8_t mavlink_msg_digicam_control_get_session(const mavlink_message_t* msg)
{
 ...
 */
static __inline uint8_t mavlink_msg_digicam_control_get_zoom_pos(const mavlink_message_t* msg)
{
 ...
 */
static __inline int8_t mavlink_msg_digicam_control_get_zoom_step(const mavlink_message_t* msg)
{
 ...
 */
static __inline uint8_t mavlink_msg_digicam_control_get_focus_lock(const mavlink_message_t* msg)
{
 ...
 */
static __inline uint8_t mavlink_msg_digicam_control_get_shot(const mavlink_message_t* msg)
{
 ...
 */
static __inline uint8_t mavlink_msg_digicam_control_get_command_id(const mavlink_message_t* msg)
{
 ...
 */
static __inline uint8_t mavlink_msg_digicam_control_get_extra_param(const mavlink_message_t* msg)
{
 ...
 */
static __inline float mavlink_msg_digicam_control_get_extra_value(const mavlink_message_t* msg)
{
 ...
 */
static __inline void mavlink_msg_digicam_control_decode(const mavlink_message_t* msg, mavlink_digicam_control_t* digicam_control)
{
